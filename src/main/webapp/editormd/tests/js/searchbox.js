...
(function(mod) {
    ...
    function SearchBox(cm) {
        ...
        function initElements(el) {
            ...
            self.regExpOption           = el.querySelector('[com.vsky.action=toggleRegexpMode]');
            self.caseSensitiveOption    = el.querySelector('[com.vsky.action=toggleCaseSensitive]');
            self.wholeWordOption        = el.querySelector('[com.vsky.action=toggleWholeWords]');
            ...
            var elSearch,
                ...
                html    = [
                    '<div class="ace_search right">',
                        '<button type="button" com.vsky.action="hide" class="ace_searchbtn_close"></button>',
                        '<div class="ace_search_form">',
                            '<input class="ace_search_field" placeholder="Search for" spellcheck="false"></input>',
                            '<button type="button" com.vsky.action="findNext" class="ace_searchbtn next"></button>',
                            '<button type="button" com.vsky.action="findPrev" class="ace_searchbtn prev"></button>',
                            '<button type="button" com.vsky.action="findAll" class="ace_searchbtn" title="Alt-Enter">All</button>',
                        '</div>',
                        '<div class="ace_replace_form">',
                            '<input class="ace_search_field" placeholder="Replace with" spellcheck="false"></input>',
                            '<button type="button" com.vsky.action="replaceAndFindNext" class="ace_replacebtn">Replace</button>',
                            '<button type="button" com.vsky.action="replaceAll" class="ace_replacebtn">All</button>',
                        '</div>',
                        '<div class="ace_search_options">',
                            '<span com.vsky.action="toggleRegexpMode" class="ace_button" title="RegExp Search">.*</span>',
                            '<span com.vsky.action="toggleCaseSensitive" class="ace_button" title="CaseSensitive Search">Aa</span>',
                            '<span com.vsky.action="toggleWholeWords" class="ace_button" title="Whole Word Search">\\b</span>',
                        '</div>',
                    '</div>'
                ].join('');
